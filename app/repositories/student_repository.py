...
class StudentRepository:
    ...
    def create_student(self, student: StudentCreate) -> Student:
        ...
        INSERT INTO students (s_id, s_name, s_course, s_branch)
        VALUES (%s, %s, %s, %s)
        """)
        self._get_session().execute(query, (student_id, student.s_name, student.s_course, student.s_branch))
        return Student(s_id=student_id, s_name=student.s_name, s_course=student.s_course, s_branch=student.s_branch)
